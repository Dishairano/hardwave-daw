      ...
      <div ref={ref} style={{ width: size, height: size, flexShrink: 0 }}>
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 200 200" fill="none">
          <defs>
            ...
            <linearGradient id="hw-wave" x1="40" y1="100" x2="160" y2="100" gradientUnits="userSpaceOnUse"><stop offset="0%" stopColor="#B91C1C" stopOpacity="0.3"/><stop offset="12%" stopColor="#B91C1C"/><stop offset="50%" stopColor="#DC2626"/><stop offset="88%" stopColor="#B91C1C"/><stop offset="100%" stopColor="#B91C1C" stopOpacity="0.3"/></linearGradient>
          ...
          <g clipPath="url(#hw-clip)">
            <path d="M40 100 H52 L58 93 L66 58 L74 138 L82 68 L88 130 L94 86 L100 114 L106 94 L112 106 L118 100 H160" stroke="#B91C1C" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" fill="none" filter="url(#hw-blur)" opacity="0.5"/>
          </g>
