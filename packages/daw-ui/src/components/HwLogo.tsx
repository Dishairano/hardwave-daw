      ...
      <div ref={ref} style={{ width: size, height: size, flexShrink: 0 }}>
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 200 200" fill="none">
          <defs>
            ...
            <radialGradient id="hw-glow" cx="100" cy="100" r="65" gradientUnits="userSpaceOnUse"><stop offset="0%" stopColor="#9B6DFF" stopOpacity="0.18"/><stop offset="40%" stopColor="#9B6DFF" stopOpacity="0.08"/><stop offset="100%" stopColor="#9B6DFF" stopOpacity="0"/></radialGradient>
            <linearGradient id="hw-wave" x1="40" y1="100" x2="160" y2="100" gradientUnits="userSpaceOnUse"><stop offset="0%" stopColor="#7B5AC0" stopOpacity="0.3"/><stop offset="12%" stopColor="#7B5AC0"/><stop offset="50%" stopColor="#9B6DFF"/><stop offset="88%" stopColor="#7B5AC0"/><stop offset="100%" stopColor="#7B5AC0" stopOpacity="0.3"/></linearGradient>
          ...
          <g clipPath="url(#hw-clip)">
            <path d="M40 100 H52 L58 93 L66 58 L74 138 L82 68 L88 130 L94 86 L100 114 L106 94 L112 106 L118 100 H160" stroke="#7B5AC0" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" fill="none" filter="url(#hw-blur)" opacity="0.5"/>
          </g>
